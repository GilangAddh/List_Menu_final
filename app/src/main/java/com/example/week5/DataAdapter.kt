...
import com.example.week5.makanan.EditMakananActivity
import java.io.File

class DataAdapter (private val makananList: ArrayList<Makanan>) :
    RecyclerView.Adapter<DataAdapter.MakananViewHolder>() {
